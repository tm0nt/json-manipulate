...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///home/tassio/jsonc/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/tassio/jsonc/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/tassio/jsonc/node_modules/devalue/index.js';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///home/tassio/jsonc/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/tassio/jsonc/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///home/tassio/jsonc/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/tassio/jsonc/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/tassio/jsonc/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/tassio/jsonc/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/tassio/jsonc/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///home/tassio/jsonc/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///home/tassio/jsonc/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/tassio/jsonc/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/tassio/jsonc/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/tassio/jsonc/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/tassio/jsonc/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/tassio/jsonc/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///home/tassio/jsonc/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///home/tassio/jsonc/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/tassio/jsonc/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "pwaManifest": {
      ...
      "icons": [
        {
          "src": "/_nuxt/icons/64x64.c1bb0bf6.png",
          "type": "image/png",
          "sizes": "64x64",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/64x64.maskable.c1bb0bf6.png",
          "type": "image/png",
          "sizes": "64x64",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/120x120.c1bb0bf6.png",
          "type": "image/png",
          "sizes": "120x120",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/120x120.maskable.c1bb0bf6.png",
          "type": "image/png",
          "sizes": "120x120",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/144x144.c1bb0bf6.png",
          "type": "image/png",
          "sizes": "144x144",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/144x144.maskable.c1bb0bf6.png",
          "type": "image/png",
          "sizes": "144x144",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/152x152.c1bb0bf6.png",
          "type": "image/png",
          "sizes": "152x152",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/152x152.maskable.c1bb0bf6.png",
          "type": "image/png",
          "sizes": "152x152",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/192x192.c1bb0bf6.png",
          "type": "image/png",
          "sizes": "192x192",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/192x192.maskable.c1bb0bf6.png",
          "type": "image/png",
          "sizes": "192x192",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/384x384.c1bb0bf6.png",
          "type": "image/png",
          "sizes": "384x384",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/384x384.maskable.c1bb0bf6.png",
          "type": "image/png",
          "sizes": "384x384",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/512x512.c1bb0bf6.png",
          "type": "image/png",
          "sizes": "512x512",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/512x512.maskable.c1bb0bf6.png",
          "type": "image/png",
          "sizes": "512x512",
          "purpose": "maskable"
        }
...
const serverAssets = [{"baseName":"server","dir":"/home/tassio/jsonc/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/tassio/jsonc","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/tassio/jsonc/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/tassio/jsonc/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/tassio/jsonc/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/tassio/jsonc/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _CMwi5nHneR = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const _dCjXnUMkqI = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _V6Jt8j = defineEventHandler(() => useRuntimeConfig().public.pwaManifest);

const _lazy_D9uacA = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_D9uacA, lazy: true, middleware: false, method: undefined },
  { route: '/manifest.json', handler: _V6Jt8j, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_D9uacA, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///home/tassio/jsonc/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/tassio/jsonc/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
